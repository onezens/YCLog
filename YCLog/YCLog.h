...
#define YC_FILE [NSString stringWithCString:__BASE_FILE__ encoding:NSUTF8StringEncoding].lastPathComponent
    ...
    #define YCLogInfo(...) YC_LOG_INTERNAL(5, kCFLogLevelNotice,  __VA_ARGS__)
    #define YCLogWarn(...) YC_LOG_INTERNAL(3, kCFLogLevelWarning, __VA_ARGS__)
    #define YCLogError(...) YC_LOG_INTERNAL(1, kCFLogLevelError, __VA_ARGS__)
    #define YCLogDebug(...) YC_LOG_INTERNAL(6, kCFLogLevelNotice, __VA_ARGS__)
